...
namespace BudgetPlanner.Controllers
{
    ...
    public class AccountTypesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Type,Descrtiption")] AccountType accountType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Type,Descrtiption")] AccountType accountType)
        {
            if (ModelState.IsValid)
            {
